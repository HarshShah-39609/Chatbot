...
//     setMessages([{ text: "Hi, I Am AQE ChatBot, How can I help you?", isUser: false }]);
...
//       const response = await axios.post(`http://localhost:8000/chat?prompt=${question}`);
...
//       {isOpen && (
//         <div style={{ marginLeft: '20px', border: '2px solid black', borderRadius: '20px', padding: '10px', backgroundImage: `url(${Chatbot})`, backgroundSize: '50%', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' }}>
...
//             </div>
//             <Typography style={{ fontSize: "20px", marginTop: '5px' }}>AQE Bot</Typography>
...
//         </div>
//       )}
//       <Button style={{ color: 'black' }} size='large' onClick={toggleChat}>
        ...
        <div style={{ position: 'fixed', bottom: '150px', right: '30px', zIndex: 95, maxWidth: '350px' }}>
          <div style={{ border: '2px solid black', borderRadius: '20px', padding: '10px', backgroundImage: `url(${Chatbot})`, backgroundSize: '50%', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' }}>
            <div className="chatbot-header" style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '2px solid black' }}>
              ...
              <Typography style={{ fontSize: "20px", marginTop: '5px', fontWeight: 'bold' }}>AQE Bot</Typography>
              <IconButton style={{ color: 'black' }} onClick={toggleChat} className="close-button">
                <CloseIcon />
              </IconButton>
            </div>
